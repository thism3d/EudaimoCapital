        ...
        fetch(`api.php?q=${query}`)
            ...
            .then(data => {
                ...
                data.forEach((user, index) => {
                    ...
                    userItem.innerHTML = `
                        <div>
                            <strong>Name: </strong><span class="text-gray-500 user-id">${user.firstName}</span>
                            <br>
                            ...
                            <br>
                            <strong>Language: </strong><span class="text-gray-500 user-id">${user.language}</span>
                            <br>
                            <strong>Balance: </strong><span class="text-gray-500 user-id">${user.score}</span>
                        </div>
                    `;
