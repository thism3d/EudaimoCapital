...
<html lang="en">
    <head>
        ...
        <script type="module" crossorigin src="/assets/index-2f78f68e.js?v=35"></script>
    ...
    <body data-mode="dark">
        ...
        <div id="woof">woof</div>
            ...
            <img id="loader" src="assets/age-wallet-transparent2.png" viewBox="0 0 237 245" fill="none" style="max-width: none">
        </div>
         <div id="off-loader">
         <img id="loader" src="assets/age-wallet-transparent2.png" viewBox="0 0 237 245" fill="none" style="max-width: none">
